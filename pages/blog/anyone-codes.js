	...
	return (
		<section className={`${styles.blogBody} ${theme}`}>
			...
			<p className={styles.blogParagraph}>
				Hi there! I see you sitting there wondering to yourself: &quot;How can I
				get started coding?&quot; Don&apos;t worry-I'm not going to bore you
				with a traditional <em>beginner&apos;s coding tutorial</em>! Instead, my
				aim with this blog post is to attempt to describe coding as one might
				approach it from various non-coding perspectives, and I will attempt to
				do so as accessibly as possible. Each section will serve as a
			...
			{variant[1].indexOf(1) !== -1 ? (
				<>
					...
					<p className={styles.blogParagraph}>
						...
						fits perfectly in this example because it doesn't really /do/ much
						of anything! It just sits there! As with our skeletons, though, it's
						...
						build with Legos, you can likely teach yourself how to build an HTML
						site, if provided with the right pathway!
					</p>{' '}
				</>
			) : null}
			{variant[1].indexOf(1) !== -1 ? (
